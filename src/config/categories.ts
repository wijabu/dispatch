...
export const CATEGORY_SUGGESTIONS: Record<string, string[]> = {
  watches: ["Brand", "Model", "Reference", "Variant", "Movement", "Diameter", "Thickness", "Lug Width", "Lug-to-Lug", "Water Resistance", "Condition Rating", "Box/Papers", "Kit", "Kit Contents", "Accessories", "Year"],
